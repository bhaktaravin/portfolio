...
import { CURRENTLY_LEARNING, SKILL_CATEGORIES } from '../data/portfolio.data';
...
export class SkillsComponent {
  readonly currentlyLearning = CURRENTLY_LEARNING;
  ...
  getSkillIcon(skill: string): string | null {
    if (skill.toLowerCase() === 'typescript') return this.skillIcons['TypeScript'];
    if (skill.toLowerCase() === 'javascript') return this.skillIcons['JavaScript'];
    if (skill.toLowerCase() === 'reactjs' || skill.toLowerCase() === 'react') return this.skillIcons['React'];
    if (skill.toLowerCase() === 'angularjs' || skill.toLowerCase() === 'angular') return this.skillIcons['Angular'];
    if (skill.toLowerCase() === 'css3' || skill.toLowerCase() === 'css') return this.skillIcons['CSS3'];
    if (skill.toLowerCase() === 'html5' || skill.toLowerCase() === 'html') return this.skillIcons['HTML5'];
