...
export const PROJECTS: Project[] = [
  ...
  },
  {
    slug: 'orbit-shell',
    title: 'Orbit Shell',
    description: 'Cross-platform Rust shell with an orbital UX — native pipes, persistent history, and a mission-style flight log.',
    technologies: ['Rust', 'CLI', 'rustyline'],
    githubUrl: 'https://github.com/bhaktaravin/orbit-shell',
    image: 'assets/orbit-shell.png',
    featured: true,
    caseStudy: {
      problem: 'Most hobby shells look and behave like bash clones. I wanted a systems project that teaches process spawning and shell internals while feeling distinct enough to remember.',
      solution: 'Built orbit-shell in Rust with native pipe wiring, rustyline-powered history (up/down and Ctrl+R), quote-aware pipeline parsing, and an orbital theme — custom prompt with exit-code telemetry (ready · stable · debris field), trajectory previews for piped commands, and a flightlog builtin backed by timestamped mission logs. Styling respects NO_COLOR; builtins cover cd, ls, flightlog, and dock.',
      impact: 'Demonstrates practical Rust systems programming, CLI UX design, and in-process pipeline orchestration — not just delegating everything to /bin/sh. An orbital status bar surfaces exit-code telemetry directly in the prompt.',
      highlights: [
        'Native pipes with trajectory preview (ls ══▶ grep ══▶ wc)',
        'Orbital status bar — ready · stable · debris field · <code>',
        'Persistent history and flightlog mission log with timestamps',
      ],
    },
  },
];
...
export const EXPERIENCES: ExperienceEntry[] = [
  {
    ...
    details: [
      'Co-founding Wov3, Inc — recovery footwear with 3D-printed lattice structures customized per athlete through foot scanning, gait capture, and discipline-specific tuning.',
      'Leading engineering for the production e-commerce and fitting platform at wov3.com — React on Vercel, scan-to-print storytelling, Calendly booking, and athlete social proof.',
  ...
  },
  {
    ...
    details: [
      'Freelance client work — websites, web apps, and AI-assisted marketing: copy, social posts, ad creative, and campaign assets generated and refined with LLM workflows.',
      'Delivered client-facing platforms (consulting sites, event management, membership apps) on AWS Amplify and Vercel with responsive UX and production-ready architecture.',
      'Shipped Career Copilot and other AI tooling — LLM-powered resume analysis, JD matching, and interview practice.',
    ],
    companyUrl: '',
  },
  {
