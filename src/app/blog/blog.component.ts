...
import { BlogService, BlogPost, BlogFilters, BlogSortBy } from '../services/blog.service';
      ...
      <div class="container">
        ...
        <div class="blog-hero">
          ...
          <p class="blog-subtitle">
            Insights on modern web development, cloud technologies, and software engineering best practices.
          </p>
          <div class="blog-stats">
            ...
            <div class="stat">
              <span class="stat-value">{{ blogService.categories().length }}</span>
        ...
        <div class="blog-controls">
          <div class="search-container">
            <div class="search-input-wrapper">
              ...
              />
              <button class="search-btn" type="button" [attr.aria-label]="'Search'">
        ...
        <div class="featured-section" *ngIf="shouldShowFeatured()">
          ...
          <div class="featured-grid">
            <article
              *ngFor="let post of blogService.featuredPosts(); trackBy: trackPost"
            ...
            >
              ...
              <div class="post-content">
                <div class="post-meta">
                  ...
                  >
                    <span class="category-icon" [innerHTML]="post.category.icon"></span>
                    {{ post.category.name }}
                  </span>
                  <time class="post-date" [attr.datetime]="post.publishedAt.toISOString()">
                ...
                <div class="post-stats">
                  <div class="stat-item">
                    ...
                    <span class="stat-text">{{ formatNumber(post.analytics.views) }}</span>
                  </div>
                  <div class="stat-item">
                    <span class="stat-icon">❤️</span>
                    <span class="stat-text">{{ formatNumber(post.analytics.likes) }}</span>
                  </div>
                </div>
              </div>
            </article>
        ...
        <div class="posts-section">
          <div class="posts-header">
            <h2 class="section-title">
              {{ getPostsTitle() }}
              <span class="post-count">({{ blogService.filteredPosts().length }})</span>
            </h2>
            ...
            <div class="active-filters" *ngIf="hasActiveFilters()">
              ...
              <button class="clear-all-btn" (click)="clearAllFilters()" type="button">
                Clear All
              </button>
            </div>
          </div>
          ...
          <div class="error-state" *ngIf="blogService.error()">
            <div class="error-content">
              ...
              <button class="btn btn-primary" (click)="retryLoading()" type="button">
                Try Again
              </button>
            </div>
          </div>
          ...
          <!-- Posts Grid -->
          <div class="posts-grid" *ngIf="!blogService.loading() && !blogService.error()">
            <article
              *ngFor="let post of blogService.filteredPosts(); trackBy: trackPost; let i = index"
              ...
              <div class="post-image" *ngIf="post.coverImage">
                ...
                <div class="post-overlay">
                  ...
                  <button
                    ...
                    [attr.aria-label]="isPostLiked(post.id) ? 'Unlike post' : 'Like post'"
                    type="button"
                  >
                    <span class="like-icon">{{ isPostLiked(post.id) ? '❤️' : '🤍' }}</span>
                  </button>
                </div>
              </div>
              <div class="post-content">
          ...
          <!-- Empty State -->
          <div class="empty-state" *ngIf="!blogService.loading() && !blogService.error() && blogService.filteredPosts().length === 0">
            <div class="empty-content">
              ...
              <button class="btn btn-outline" (click)="clearAllFilters()" type="button">
                Clear Filters
              </button>
            </div>
          </div>
        ...
        <div class="newsletter-section" *ngIf="!hasActiveFilters()">
          <div class="newsletter-content">
            ...
            <form class="newsletter-form" (ngSubmit)="subscribeToNewsletter($event)">
              <div class="form-group">
                ...
                />
                <button class="btn btn-primary" type="submit" [disabled]="!newsletterEmail">
                  Subscribe
                </button>
              </div>
            </form>
...
export class BlogComponent implements OnInit {
  ...
  shouldShowFeatured(): boolean {
    return !this.hasActiveFilters() && this.blogService.featuredPosts().length > 0;
  }
  ...
  getCategoryName(slug: string): string {
    const category = this.blogService.categories()
      .find(c => c.category.slug === slug);
    return category?.category.name || slug;
  }

  getTotalViews(): string {
    const total = this.blogService.posts()
